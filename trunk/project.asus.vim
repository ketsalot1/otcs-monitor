...
let s:l = 78 - ((25 * winheight(0) + 21) / 42)
...
253
normal zo
let s:l = 286 - ((20 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
286
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 165 - ((147 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
165
...
15
normal zo
let s:l = 129 - ((64 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
129
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 113 - ((22 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
...
exe '3resize ' . ((&lines * 20 + 22) / 44)
exe 'vert 3resize ' . ((&columns * 94 + 95) / 190)
tabedit app/view/searchForm.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 88 - ((87 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
