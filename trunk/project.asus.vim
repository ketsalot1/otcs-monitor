...
set showmatch
set smartcase
set spellfile=~/custom.en.ascii.add
...
set shortmess=aoO
badd +1 app.js
badd +143 app/controller/itsm.js
...
badd +1 app/view/itsmPatchAssignForm.js
badd +1 app/store/patches.js
badd +1 app/model/patches.js
badd +1 app/view/patchMainView.js
badd +105 app/view/patchMgmtUpdateForm.js
badd +1 app/view/patchMgmtInsertForm.js
badd +7 styles/config.rb
badd +0 app/view/projectMgmtInsertForm.js
badd +0 app/view/itsmEditForm.js
badd +39 sync.sh
badd +10 app/view/itsmProjectAssignForm.js
silent! argdel *
edit app.js
...
let s:l = 101 - ((27 * winheight(0) + 21) / 42)
...
433
normal zo
let s:l = 448 - ((168 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
448
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 231 - ((199 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
231
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 168 - ((167 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
168
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 45 - ((44 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 10 - ((0 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
exe '3resize ' . ((&lines * 20 + 22) / 44)
exe 'vert 3resize ' . ((&columns * 94 + 95) / 190)
tabedit app/view/itsmPatchAssignForm.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 118 - ((117 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
...
exe '3resize ' . ((&lines * 20 + 22) / 44)
exe 'vert 3resize ' . ((&columns * 94 + 95) / 190)
tabedit app/view/itsmProjectAssignForm.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 107 - ((98 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
normal! 058l
2wincmd w
tabedit app/view/patchMainView.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
2wincmd w
tabedit app/view/itsmEditForm.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit app/view/projectMgmtInsertForm.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
