...
badd +3 app/view/itsmPatchAssignForm.js
badd +1 app/store/patches.js
badd +1 app/model/patches.js
badd +90 app/view/patchMainView.js
badd +86 app/view/patchMgmtUpdateForm.js
badd +10 app/view/patchMgmtInsertForm.js
badd +1 app/view/projectMgmtInsertForm.js
badd +86 app/view/itsmEditForm.js
badd +38 sync.sh
badd +0 app/view/itsmLinkForms.js
silent! argdel *
edit app.js
...
let s:l = 30 - ((24 * winheight(0) + 21) / 42)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 66 - ((34 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 269 - ((20 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
269
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 127 - ((119 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
127
...
11
normal zo
let s:l = 26 - ((16 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
wincmd w
argglobal
edit app/view/patchMgmtUpdateForm.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
