...
badd +9622 resources/css/app.css
...
badd +0 app/view/itsmOverview.js
silent! argdel *
edit app.js
...
let s:l = 51 - ((15 * winheight(0) + 21) / 42)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 265 - ((58 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
265
...
27
normal zo
let s:l = 37 - ((6 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 81 - ((27 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 9629 - ((17 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9629
