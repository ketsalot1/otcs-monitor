...
badd +76 app/view/searchForm.js
badd +34 app/view/searchResultView.js
badd +10 app/view/searchResultDetail.js
badd +8 app/model/searchresult.js
badd +1 app/store/searchresult.js
badd +8 ~/.vimrc
badd +9 app/view/aboutScreen.js
badd +13 app/model/aboutInfo.js
badd +40 app/store/aboutInfo.js
silent! argdel *
edit app.js
...
exe 'vert 1resize ' . ((&columns * 69 + 87) / 174)
exe 'vert 2resize ' . ((&columns * 104 + 87) / 174)
argglobal
setlocal keymap=
setlocal noarabic
...
785
normal zo
let s:l = 137 - ((22 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
...
exe '2resize ' . ((&lines * 27 + 22) / 44)
exe 'vert 2resize ' . ((&columns * 77 + 87) / 174)
exe '3resize ' . ((&lines * 14 + 22) / 44)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 257 - ((226 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
257
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 192 - ((183 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
192
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 47 - ((46 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
47
