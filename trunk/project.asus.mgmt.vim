...
set shortmess=aoO
badd +109 app/view/patchMainView.js
...
badd +0 [s]
badd +67 app/view/ConfigurationView.js
...
334
normal zo
let s:l = 337 - ((102 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
337
...
exe '3resize ' . ((&lines * 20 + 22) / 44)
exe 'vert 3resize ' . ((&columns * 93 + 95) / 190)
tabedit app/view/patchMgmtInsertForm.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
12
normal! 01l
tabedit app/view/projectMgmtInsertForm.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
11
normal zo
let s:l = 42 - ((35 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
